...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        CommonApplication.context.startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) CommonApplication.context.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) CommonApplication.context.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) CommonApplication.context.getSystemService(Context.WIFI_SERVICE);
